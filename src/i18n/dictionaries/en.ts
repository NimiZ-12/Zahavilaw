    ...
    members: [
      {
        ...
        about:
          "Ron Zahavi, Adv. is a founding partner of the firm and has been a member of the Israel Bar Association since 1996, and is regarded as a leading commercial litigator in his field. He represents companies, controlling shareholders and other stakeholders in complex civil and commercial proceedings before every court and tribunal — including class actions, shareholder disputes, and large-scale contractual and economic disputes — leading each matter from filing through to resolution. Alongside his litigation practice, he guides commercial companies and corporations throughout their lifecycle — from formation and founders' agreements, through ongoing commercial transactions and arrangements, to managing crises among shareholders and with suppliers, customers and creditors. He has also built broad expertise in real estate law in all its aspects — from sale and purchase transactions, through dealings with the Israel Land Authority, agricultural land and smallholdings, to TAMA 38 urban-renewal projects, co-ownership agreements and the dissolution of shared ownership — as well as representing clients in inheritance and estate disputes. His work is grounded in close, hands-on involvement in every case, alongside a commitment to availability and professional service.",
      ...
      },
      {
        ...
        about:
          "Anat Zahavi, Adv. is a founding partner of the firm, a member of the Israel Bar Association since 1996, and a certified mediator in labor disputes, with over two decades of experience in the field. She specializes in representing employers — including some of Israel's largest companies, food and fast-food chains, telecom and hi-tech companies, import and manufacturing businesses, construction companies and private employers — in proceedings before the Regional and National Labor Courts throughout the country. Her practice is built on a preventive labor law approach, under which she advises clients on an ongoing basis on the applicability of collective agreements and extension orders, the employment and dismissal of pregnant employees, workplace sexual harassment, and disciplinary and criminal matters in the workplace, including proceedings before the Ministry of Economy under the Increased Enforcement of Labor Laws Law. Alongside her legal practice, she conducts workshops and training sessions for senior and mid-level management on labor relations and the managerial prerogative, equipping employers with the tools to manage their workforce properly while exercising their lawful management rights.",
