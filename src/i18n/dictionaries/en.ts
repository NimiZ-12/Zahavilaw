    ...
    members: [
      {
        ...
        bio: "Specializes in civil and commercial litigation and corporate law, with extensive experience managing complex cases in court.",
      },
      {
        name: "Dana Levi, Adv.",
        role: "Partner",
        bio: "Leads the family and real estate practice, guiding clients with sensitivity and professionalism through pivotal moments in life.",
      },
      {
        name: "Michael Bar-On, Adv.",
        role: "Senior Attorney",
        bio: "Specializes in labor law and ongoing commercial counsel for businesses, from formation through growth.",
      },
    ],
  },
  contact: {
    ...
    address: "Justice Tower, 1 Herzl St., Tel Aviv",
